...
public class Account {
    ...
    public void deposit(double amount) throws NegativeAmountException {
        try {
            if (amount < 0) throw new NegativeAmountException("The amount " + amount + " must not be positive");
            balance += amount;
            // log
    ...
    public void withdraw(double amount, String ssn)
        ...
        try {
            if (amount < 0) throw new NegativeAmountException("The amount= " + amount + " should not be positive");
