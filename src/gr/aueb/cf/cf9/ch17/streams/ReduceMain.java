...
public class ReduceMain {
    ...
    public static void main(String[] args) {
        ...
        int sumOfQuantities2 = products.stream()
                .mapToInt(Product::getQuantity)
                .sum();             // works with primitive types Είναι μέθοδος της ιδιας της Stream
        ...
        var sortedProductsDescriptionsGEQ100 = products.stream()
                ...
                .sorted(Comparator.comparing(Product::getDescription))  // Σορτάρει products με βάση το description
                .map(Product::getDescription)                           // Επιστρέφει μόνο Strings
